...
class _BeforeCleaningBodyState extends State<BeforeCleaningBody> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: NormalText(
          text: Utils.translate("home_diagnosis"),
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => DiagnosisScreen(
                    personModel: _childrensSelected[
                        0], // Aquí pasas el PersonModel seleccionado
                  ),
                ),
              ).then((_) async {
                _initializeCamera();
              ...
              child: Column(
                ...
                children: [
                  Icon(
                    ...
                    color: Utils.isDarkMode ? kWhiteColor : kButtonColor,
                    size: kLargeFontSize,
                  ),
                  NormalText(
                    text: "Historial",
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: CustomPaint(
              painter: HolePainter(
                  position: Offset(200, 350)), //Aqui modifica x y del recuadro
            ),
          ),
          ...
          Positioned(
            ...
            child: Center(
              child: Text(
                "Elige a quién pertenece la foto y sonríe mostrando tus dientes dentro del recuadro para continuar.",
          ...
          Positioned(
            ...
            child: Center(
              child: Text(
                "* Este diagnóstico es una referencia y puede no ser 100% preciso. Para un diagnóstico certero, te recomendamos agendar una cita con un especialista.",
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 12,
                  fontWeight: FontWeight.bold,
                          ...
                          await Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                              builder: (context) => AfterCleaningScreen(
                                  cameFromBrushing: widget.cameFromBrushing,
                                  selectedChild: widget.selectedChild
                                  // Uso de nombre de argumento
                                  ),
                            ),
                          );
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  Navigator.pop(context,
                                      child); // <- Devuelve el child seleccionado
                                },
                              ),
                            );
                          },
